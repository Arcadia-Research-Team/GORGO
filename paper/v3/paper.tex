...
per replica). GORGO does not currently model heterogeneous hardware setups,
where replicas may have different prefill rates, queueing behavior, or KV-cache
capacities; generalization to other workloads and replica counts is also
untested. Second, because the online
...
this. Third, we do not consider prefill/decode disaggregation, which introduces
separate worker queues and KV-transfer costs. Finally, GORGO does not manage or
